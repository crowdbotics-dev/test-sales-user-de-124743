...
## Project Structure
    ...
    ├── test_sales_user_de_124743  # Django project configurations
...
1. Clone this repo and `cd test_sales_user_de_124743`
...
2. Clone this repo and `cd test_sales_user_de_124743`
